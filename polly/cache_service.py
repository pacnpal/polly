...
class CacheService:
    ...
    # Guild Data Caching
    async def cache_user_guilds(self, user_id: str, guilds: List[Dict[str, Any]]) -> bool:
    ...
    async def get_cached_user_guilds(self, user_id: str) -> Optional[List[Dict[str, Any]]]:
    ...
    async def cache_guild_channels(self, guild_id: str, channels: List[Dict[str, Any]]) -> bool:
    ...
    async def get_cached_guild_channels(self, guild_id: str) -> Optional[List[Dict[str, Any]]]:
    ...
    # Guild Roles Caching
    async def cache_guild_roles(self, guild_id: str, roles: List[Dict[str, Any]]) -> bool:
        """Cache guild roles"""
        redis_client = await self._get_redis()
        if not redis_client:
            return False
    ...
    async def get_cached_guild_roles(self, guild_id: str) -> Optional[List[Dict[str, Any]]]:
    ...
    async def cache_guild_emojis(self, guild_id: str, emojis: List[Dict[str, Any]]) -> bool:
        """Cache guild emojis"""
        redis_client = await self._get_redis()
        if not redis_client:
            return False
    ...
    async def get_cached_guild_emojis(self, guild_id: str) -> Optional[List[Dict[str, Any]]]:
