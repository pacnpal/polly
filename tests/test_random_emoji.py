...
class TestRandomEmojiGeneration:
    ...
    def test_get_random_poll_emojis_prioritizes_common_emojis(self):
        ...
        common_found = any(emoji_char in common_poll_emojis for emoji_char in poll_emojis)
...
class TestRandomEmojiIntegration:
    ...
    def test_sample_poll_data_with_random_emojis_fixture(self, sample_poll_data_with_random_emojis):
    ...
    def test_sample_poll_with_random_emojis_fixture(self, sample_poll_with_random_emojis):
